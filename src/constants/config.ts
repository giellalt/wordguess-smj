export const CONFIG = {
  ...
  wordListSource: 'GiellaLT/lang-smj', // Describe the source material for your words here
  wordListSourceLink: 'https://github.com/giellalt/lang-smj', // Put a link to the source material for your words here
  //
  ...
  startDate: 'March 12, 2024 00:00:00', // what date and time to start your game from
  defaultLang: 'en', // the default interface language
  availableLangs: ['en', 'es', 'sw', 'zh', 'smj'], // the options available to the user for translation languages
